class User < ActiveRecord::Base
	...
	validates :email, :name, :phone_number, :address, :graduation_year, :profile_picture_url, :willing_to_pay_amount, :description, :phone_number_public, :address_public, :out_of_town, :email_public, presence: true
